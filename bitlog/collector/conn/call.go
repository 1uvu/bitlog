...
type callFunc func(c *RPConn, arg *ConnCallArg, reply *ConnCallReply)
...
func handleGetBestBlock(c *RPConn, arg *ConnCallArg, reply *ConnCallReply) {
	h, d, err := c.client.GetBestBlock()
